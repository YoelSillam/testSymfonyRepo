...
class EtudiantController extends AbstractController
{
    ...
    public function indexFiltre(EtudiantRepository $etudiantRepository,Request $request): Response
    {
        $sexeTab = [0=>"non binaire",1=>"homme",2=>"femme"];
        return $this->render('etudiant/filtre.html.twig', [
            'etudiants' => $etudiantRepository->findBy(['sexe'=>$request->request->get("sexeFiltre") ]),
            'sexeTab'=> $sexeTab
